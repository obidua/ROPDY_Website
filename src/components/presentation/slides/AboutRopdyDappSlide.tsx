  ...
  return (
    <div className="text-center">
      ...
      <motion.div
        ...
        className="mb-8 sm:mb-12 cyber-card p-4 sm:p-8 bg-gradient-to-br from-green-900/30 to-black/50"
      >
        <h2 className="text-xl sm:text-3xl font-bold text-white mb-4 sm:mb-6">What is ROPDY?</h2>
        <p className="text-base sm:text-lg text-gray-300 max-w-4xl mx-auto mb-4 sm:mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div className="cyber-card p-3 sm:p-4 bg-gradient-to-br from-emerald-900/20 to-black/50">
            <Globe className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-400 mx-auto mb-2 sm:mb-3" />
            <h3 className="text-base sm:text-lg font-semibold text-white mb-1 sm:mb-2">Global Access</h3>
            <p className="text-xs sm:text-sm text-gray-300">Anyone, anywhere can join with a Web3 wallet</p>
          </div>
          <div className="cyber-card p-3 sm:p-4 bg-gradient-to-br from-blue-900/20 to-black/50">
            <Lock className="w-6 h-6 sm:w-8 sm:h-8 text-blue-400 mx-auto mb-2 sm:mb-3" />
            <h3 className="text-base sm:text-lg font-semibold text-white mb-1 sm:mb-2">No KYC Required</h3>
            <p className="text-xs sm:text-sm text-gray-300">Complete privacy and anonymity</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <h2 className="text-xl sm:text-3xl font-bold text-white mb-4 sm:mb-8">Two Powerful Programs</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
          {programs.map((program, index) => (
            <div
              key={index}
              className={`cyber-card p-4 sm:p-8 bg-gradient-to-br ${program.color} hover:scale-105 transition-all duration-300`}
            >
              <div className="text-4xl sm:text-6xl mb-2 sm:mb-4">{program.icon}</div>
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-4">{program.name}</h3>
              <p className="text-sm sm:text-base text-gray-300">{program.description}</p>
            </div>
          ))}
        </div>
      </motion.div>
