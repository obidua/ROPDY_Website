  ...
  return (
    <div className="text-center">
      ...
      <motion.div
        ...
        className="mb-8 sm:mb-12 cyber-card p-4 sm:p-8 bg-gradient-to-br from-green-900/30 to-emerald-900/30"
      >
        <h2 className="text-xl sm:text-3xl font-bold text-white mb-4 sm:mb-6">How ROPDY Circle Works</h2>
      ...
      <motion.div
        ...
        className="mb-8 sm:mb-12"
      >
        <h2 className="text-xl sm:text-3xl font-bold text-white mb-4 sm:mb-8">Package Options</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-6">
          {packages.map((pkg, index) => (
            <div key={index} className="cyber-card p-4 sm:p-6 bg-gradient-to-br from-green-900/20 to-black/50 hover:scale-105 transition-all duration-300">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-4">{pkg.name}</h3>
      ...
      <motion.div
        ...
        className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 mb-4 sm:mb-8"
      >
        <div className="cyber-card p-4 sm:p-8 bg-gradient-to-br from-blue-900/30 to-cyan-900/30">
          ...
          <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-4">CP1 — Sponsor Bonus</h3>
          <p className="text-sm sm:text-base text-blue-200">50% goes directly to your sponsor/upline for instant referral rewards</p>
        </div>
        
        <div className="cyber-card p-4 sm:p-8 bg-gradient-to-br from-purple-900/30 to-indigo-900/30">
          <Target className="w-8 h-8 sm:w-12 sm:h-12 text-purple-400 mx-auto mb-2 sm:mb-4" />
          <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-4">CP2 — Global Bonus</h3>
          <p className="text-sm sm:text-base text-purple-200">50% distributed by MOD algorithm across the network</p>
        </div>
      </motion.div>
