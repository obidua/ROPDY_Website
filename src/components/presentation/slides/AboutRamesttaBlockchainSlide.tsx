  ...
  return (
    <div className="text-center">
      ...
      <motion.div
        ...
        className="mb-12 cyber-card p-8 bg-gradient-to-br from-green-900/30 to-blue-900/30"
      >
        ...
        <h2 className="text-3xl font-bold text-white mb-4">Why Choose Ramestta?</h2>
      ...
      <motion.div
        ...
        className="cyber-card p-8 bg-gradient-to-br from-indigo-900/30 to-purple-900/30"
      >
        <h3 className="text-2xl font-bold text-white mb-6">Ramestta Ecosystem</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            <div className="text-4xl mb-3">🏦</div>
            <h4 className="text-lg font-semibold text-white mb-2">DeFi Protocols</h4>
            <p className="text-gray-300 text-sm">Lending, borrowing, and yield farming</p>
          </div>
          
          <div className="text-center">
            <div className="text-4xl mb-3">🎨</div>
            <h4 className="text-lg font-semibold text-white mb-2">NFT Marketplace</h4>
            <p className="text-gray-300 text-sm">Create, trade, and collect digital assets</p>
          </div>
          
          <div className="text-center">
            <div className="text-4xl mb-3">⚡</div>
            <h4 className="text-lg font-semibold text-white mb-2">ROPDY Platform</h4>
            <p className="text-gray-300 text-sm">Decentralized earning opportunities</p>
          </div>
        </div>
      </motion.div>
    </div>
