  ...
  return (
    <div className="text-center">
      ...
      <motion.div
        ...
        className="mb-12 cyber-card p-8 bg-gradient-to-br from-indigo-900/30 to-purple-900/30"
      >
        <h2 className="text-3xl font-bold text-white mb-6">How Blockchain Works</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="cyber-card p-6 bg-gradient-to-br from-blue-900/20 to-black/50">
            <div className="text-4xl mb-4">📦</div>
            <h3 className="text-xl font-bold text-white mb-2">1. Transaction Block</h3>
            <p className="text-gray-300">Each transaction is grouped into a block with other transactions</p>
          </div>
          
          <div className="cyber-card p-6 bg-gradient-to-br from-purple-900/20 to-black/50">
            <div className="text-4xl mb-4">⛓️</div>
            <h3 className="text-xl font-bold text-white mb-2">2. Chain Formation</h3>
            <p className="text-gray-300">Blocks are linked together using cryptographic hashes</p>
          </div>
          
          <div className="cyber-card p-6 bg-gradient-to-br from-green-900/20 to-black/50">
            <div className="text-4xl mb-4">✅</div>
            <h3 className="text-xl font-bold text-white mb-2">3. Network Validation</h3>
            <p className="text-gray-300">Network participants validate and confirm transactions</p>
          </div>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {features.map((feature, index) => (
          <motion.div
            ...
            className="cyber-card p-6 bg-gradient-to-br from-gray-900/20 to-black/50 hover:from-gray-800/30 hover:to-black/60 transition-all duration-300"
          >
      ...
      <motion.div
        ...
        className="mt-12 cyber-card p-8 bg-gradient-to-br from-green-900/30 to-emerald-900/30"
      >
        <h3 className="text-2xl font-bold text-white mb-4">Why Blockchain Matters</h3>
